...
def register_all_commands(bot):
    ...
    bot.register_command(commands('listen'), cmd_listen, access_outside_channel=True)
    bot.register_command(commands('unlisten'), cmd_unlisten, access_outside_channel=True)
